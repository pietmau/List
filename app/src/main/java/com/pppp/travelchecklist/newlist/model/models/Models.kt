...
class ExpectedWeatherModel(val db: TagsCache, val id: Long) : TagSelectorModelImpl(db, id)

class AccomodationModel(val db: TagsCache, val id: Long) : TagSelectorModelImpl(db, id)

class LongOrShortTripModel(val db: TagsCache, val id: Long) : TagSelectorModelImpl(db, id)

class PlannedActivitesModel(val db: TagsCache, val id: Long) : TagSelectorModelImpl(db, id)

class WhoIsTravellingModel(val db: TagsCache, id: Long) : TagSelectorModelImpl(db, id)
