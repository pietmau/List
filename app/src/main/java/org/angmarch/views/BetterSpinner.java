...
public class BetterSpinner extends AppCompatTextView {
    ...
    public BetterSpinnerAdapter adapter;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (adapter != null && adapter.items != null) {
            bundle.putParcelableArrayList(ITEMS, new ArrayList(adapter.items));
        }
        return bundle;
    }
    ...
    public void onRestoreInstanceState(Parcelable savedState) {
        if (savedState instanceof Bundle) {
            ...
            ArrayList<Parcelable> items = bundle.getParcelableArrayList(ITEMS);
            if (items != null) {
                attachDataSource(items);
            }
    ...
    private void setAdapterInternal(BetterSpinnerAdapter adapter) {
