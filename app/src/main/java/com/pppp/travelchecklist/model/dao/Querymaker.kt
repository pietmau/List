...
class Querymaker {
    ...
    fun getCardsQuery(listId: String): String = "SELECT * FROM " + CardContract.Card.TABLE_NAME + " WHERE " + CardContract.Card.COLUMN_NAME_LIST_ID + "=" + listId

    fun getitemsQuery(cardId: String): String = "SELECT * FROM " + TravelChecklistItemContract.TravelChecklistItem.TABLE_NAME + " WHERE " + TravelChecklistItemContract.TravelChecklistItem.COLUMN_NAME_CARD_ID + "=" + cardId
